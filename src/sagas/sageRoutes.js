...
function requestRouteFilter(payload) {
    return axios.post(`https://likeshikes.somee.com/api/Routes/GetRoutesUsingFilter`, payload);
};
...
function requestDeleteRoute(payload) {
    return axios.delete(`https://likeshikes.somee.com/api/Routes/RemoveRoute?routeId=${payload}`,
...
function requestDeleteComment(payload) {
    return axios.delete(`https://likeshikes.somee.com/api/Routes/RemoveRouteReview?routeReviewId=${payload}`,
        {headers:{Authorization:`Bearer ${localStorage.getItem('token')}`}});
};
...
function requestAddComment(payload) {
    return axios.post(`https://likeshikes.somee.com/api/Routes/CreateReview`, payload,
        {headers:{Authorization:`Bearer ${localStorage.getItem('token')}`}});
};
...
function requestAddRoute(payload) {
    return axios.post(`https://likeshikes.somee.com/api/Routes/AddRouteToUser`, {RouteId: payload},
        {headers:{Authorization:`Bearer ${localStorage.getItem('token')}`}});
};
...
function requestAllRoute() {
    return  axios.get('https://likeshikes.somee.com/api/Routes/GetAllRoutes',
        {headers:{Authorization:`Bearer ${localStorage.getItem('token')}`}});
};
...
function requestRoute(payload) {
    return axios.get(`https://likeshikes.somee.com/api/Routes/GetRouteById?id=${payload}`,
        {headers:{Authorization:`Bearer ${localStorage.getItem('token')}`}});
};
