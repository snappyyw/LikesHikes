...
function requestDeleteReport(payload) {
    return axios.delete(`http://likeshikes.somee.com/api/PersonalArea/RemoveReport?routeId=${payload}`,
...
function requestReport(payload) {
        return axios.get(`http://likeshikes.somee.com/api/PersonalArea/GetReport?routeId=${payload}`,
            {headers:{Authorization:`Bearer ${localStorage.getItem('token')}`}});
};
...
function requestCreateReport(payload) {
    return axios.post(`http://likeshikes.somee.com/api/PersonalArea/CreateOrEditReport`, payload,
        {headers:{Authorization:`Bearer ${localStorage.getItem('token')}`}});
};
...
function requestCompleteRoute(payload) {
    return axios.put(`http://likeshikes.somee.com/api/PersonalArea/ChangeRoutePassed`, {RouteId: payload},
        {headers:{Authorization:`Bearer ${localStorage.getItem('token')}`}});
};
...
function requestPublishMyRoute(payload) {
    return axios.put(`http://likeshikes.somee.com/api/PersonalArea/PublishRoute`, {RouteId: payload},
        {headers:{Authorization:`Bearer ${localStorage.getItem('token')}`}});
};
...
function requestCreateRoutes(payload) {
    return axios.post(`http://likeshikes.somee.com/api/PersonalArea/CreateOrEditRoute`, payload,
        {headers:{Authorization:`Bearer ${localStorage.getItem('token')}`}});
};
...
function requestDeleteMyRoute(payload) {
    return axios.delete(`http://likeshikes.somee.com/api/PersonalArea/RemoveRoute?RouteId=${payload}`,
        {headers:{Authorization:`Bearer ${localStorage.getItem('token')}`}});
}
...
function requestRegistration(payload) {
    return axios.post(`http://likeshikes.somee.com/api/Account/registration`, payload);
}
...
function requestUserData() {
    return axios.get(`http://likeshikes.somee.com/api/PersonalArea/GetUserRoutes`,
        {headers:{Authorization:`Bearer ${localStorage.getItem('token')}`}});
}
...
function requestLogin(payload) {
    ...
    return axios.post('http://likeshikes.somee.com/api/Account/login', payload);
}
...
function requestAuth() {
    return  axios.get(`http://likeshikes.somee.com/api/Account/GetUserData`,
        {headers:{Authorization:`Bearer ${localStorage.getItem('token')}`}});
}
